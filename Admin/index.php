...
$sqlCountAccepted1 = "SELECT COUNT(*) AS car FROM tblcar where statz='selled'";
...
$sqlCountAccepted17 = "SELECT COUNT(*) AS car FROM tblcar where statz='available'";
$countAccepted17 = $obj->executequery($sqlCountAccepted17);
$rowCountAccepted17 = mysqli_fetch_assoc($countAccepted17);
$car_count7 = $rowCountAccepted17['car'];
            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Welcome carhub Admin back!!</h3>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                            <div class="card-body">
                                <p class="mb-4">Today’s Sold Car's</p>
                                <p class="fs-30 mb-2"><?php echo $car_count ?></p>
                                <!-- <p>10.00% (30 days)</p> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-dark-blue">
                            <div class="card-body">
                                <p class="mb-4">Total Carshop's</p>
                                <p class="fs-30 mb-2"><?php echo $carsh_count ?></p>
                                <!-- <p>22.00% (30 days)</p> -->
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 stretch-card transparent">
                        <div class="card card-light-danger">
                            <div class="card-body">
                                <p class="mb-4">Total Available cars</p>
                                <p class="fs-30 mb-2"><?php echo $car_count7 ?></p>
                                <!-- <p>0.22% (30 days)</p> -->
                            </div>
                        </div>
                    </div>
