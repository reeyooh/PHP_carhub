...
<body>
<form action="excel/excelcustomers.php" method="post">
<div class="logo">
              <a href="./index.php">
                <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
  ...
  <h2 style="text-align: center;margin-top: 6%;font-family: fantasy;">Customerś REPORT</h2>
