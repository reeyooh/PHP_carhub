...
// $display = mysqli_fetch_array($result);
  ...
  $sql1 = "SELECT * FROM tblcarshop  where statuss='accepted' order by carshopid ";
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
      <div class="col-md-9 ftco-animate pb-5">
        <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Carshop <i class="ion-ios-arrow-forward"></i></span></p>
        <h1 class="mb-3 bread"><b>CAR SHOPS</b> </h1>
      </div>
    </div>
  </div>
</section>
        ...
        <div class="col-md-4">
          <div class="car-wrap rounded ftco-animate">
            ...
            <div class="text">
              ...
              <b><h2  class="mb-0"><a href="viewsinglecarshop.php?carshopid=<?php echo $row['carshopid']?>"><?php echo $row["carshopname"];?> </a></b></h2>
