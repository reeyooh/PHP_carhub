<?php
// session_start(); // Uncomment this if sessions are used
        ...
        <div class="car-details">
          ...
          <div id="carPhotosCarousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item">
                <img src="../uploads/<?php echo $row['photo4']; ?>" alt="Fourth slide" style="margin-left: 215px;width: 650px;">
              </div>
            </div>
          ...
          <div class="text text-center">
            ...
            <b><h2><?php echo $row["companyname"]; ?> <?php echo $row["carname"]; ?></h2></b>

            <div class="text"> 
                      
                    <a href="register.php" class="btn btn-primary py-2 mr-1"  
                    onclick="return confirm('Register or Login required')">Request</a>
