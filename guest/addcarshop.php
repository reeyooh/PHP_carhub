...
<script>
    $(document).ready(function() {
        ...
        $("input[name='txtemail']").on("blur", function() {
            validateField("email", $(this).val(), "txtemail");
        });

        // Validate mobile
        $("input[name='txtmobile']").on("blur", function() {
            validateField("mobile", $(this).val(), "txtmobile");
        });

        // Validate username
        $("input[name='txtusername']").on("blur", function() {
            validateField("username", $(this).val(), "txtusername");
        });

        // Handle district and location
                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="addcarshopaction.php" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="txtname" class="form-control" id="txtname" placeholder="Car shop name" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" minlength="10" maxlength="10" pattern="[0-9]{10}" name="txtmobile" class="form-control" id="txtmobile" placeholder="Enter mobile" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" name="txtemail" id="email" class="form-control" id="txtemail" placeholder="Enter email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"  
...
<script>
 ...
    });
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="txtusername" class="form-control" id="txtusername" placeholder="Enter username" pattern="[a-zA-Z0-9]{5,15}"  
