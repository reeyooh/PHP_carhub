...
<body>
	...
	$sql2 = "SELECT * FROM tblcar q INNER JOIN tblcarshop d ON q.carshopid =d.carshopid INNER JOIN tblcompany w ON q.companyid =w.companyid INNER JOIN tblmodel m ON q.modelid =m.modelid where d.carshopid='$shopid'";
					...
					<div class="booking-form">
						...
						<form method="POST" action="detailpayment.php">
							...
							<div class="row">
								<div class="">
									<div class="">
										<h4><span class=""> Name : <?php echo $row1['regname']; ?></span><br>
										<span class=""> Location :<?php echo $row1['district']; ?>,<?php echo $row1['locationn']; ?></span><br>
										
										<span class=""> pincode :<?php echo $row1['pincode']; ?></span><br>
										<span class="">Mobile :<?php echo $row1['mobile']; ?></span><br>
										<span class="">Email :<?php echo $row1['email']; ?></span></h4>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<!-- <div class="col-md-6"> -->
									<div class="form-group">
										<span class="">Car shop : <?php echo $row2['carshopname']; ?> </span>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<!-- <span class="form-label">Car id</span> -->
										<!-- <input class="form-control"  type="text" name="txtcar" placeholder="Enter car id"> -->
										<div class="col-md-6">
											<input type="hidden" name="txtreg" value="<?php echo $row1['registerid']?>" >
										<button> <a href="../viewpaycar.php?carid=<?php echo $row2['carid']?> & regnumber=<?php echo $row1['regnumber']?>" class="btn btn-primary py-2 mr-1">Select car</a></button>
